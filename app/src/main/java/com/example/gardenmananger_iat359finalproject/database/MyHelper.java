...
//Define apps preset plants to select from
    private String[][] presetPlants = {
            {"Tomato", String.valueOf(R.drawable.tomato),"6-8 hrs", "60%", "15-30C","6-8 ph"},
            {"Potato",String.valueOf(R.drawable.potato),"6-8 hrs", "60%", "15-30C","6-8 ph"},
            {"Lettuce",String.valueOf(R.drawable.lettuce),"4-6 hrs", "70%", "5-20C","6-8 ph"},
            {"Carrot",String.valueOf(R.drawable.carrot),"6-8 hrs", "70%", "5-20C","6-8 ph"},
            {"Kale",String.valueOf(R.drawable.kale),"6-8 hrs", "70%", "5-20C","6-8 ph"},
//            {"Onion",String.valueOf(R.drawable.onion),"6-8 hrs", "70%", "5-20C","6-8 ph"},
            {"Spinach",String.valueOf(R.drawable.spinach),"4-6 hrs", "70%", "5-20C","6-8 ph"},
            {"Beet",String.valueOf(R.drawable.beet),"6-8 hrs", "70%", "5-20C","6-8 ph"},
//            {"Brocoili",String.valueOf(R.drawable.broccoli),"6-8 hrs", "70%", "5-20C","6-8 ph"},
            {"Basil",String.valueOf(R.drawable.basil),"6-8 hrs", "70%", "5-20C","6-8 ph"},
//            {"Cucumber",String.valueOf(R.drawable.cucumber),"6-8 hrs", "70%", "5-20C","6-8 ph"}
    };
